...
umi_methods = ['none','forward','reverse']
            ...
            if(bcID == "*" or bcID == "" or mapQ == "*" or int(mapQ) <= 20):
                ...
                for umi_method in umi_methods:
                    if umi_method == 'none':
                        ...
                        # BCUMIMap[umi_method][mykey]=1
                        BCCountList[umi_method][int(bcID)-1] = BCCountList[umi_method][int(bcID)-1] + 1
                    elif umi_method == 'forward':

                        mykey = str(bcID)+"\t"+f_umi
                        if mykey not in BCUMIMap[umi_method] or not args.UMI:
                            BCUMIMap[umi_method][mykey]=1
                            BCCountList[umi_method][int(bcID)-1] = BCCountList[umi_method][int(bcID)-1] + 1
                        else:
                            BCUMIDupCountList[umi_method][int(bcID)-1] = BCUMIDupCountList[umi_method][int(bcID)-1] + 1

                    elif umi_method == 'reverse':

                        mykey = str(bcID)+"\t"+r_umi
                        if mykey not in BCUMIMap[umi_method] or not args.UMI:
                            BCUMIMap[umi_method][mykey]=1
                            BCCountList[umi_method][int(bcID)-1] = BCCountList[umi_method][int(bcID)-1] + 1
                        else:
